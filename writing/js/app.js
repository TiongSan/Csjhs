...
function initApp() {
    ...
    document.getElementById('progress-text').innerText = `0 / ${traceableChars.length}`;
    loadCharacter(0);
    setupEvents();
}
...
function loadCharacter(index) {
    ...
    document.getElementById('progress-text').innerText = `${index + 1} / ${traceableChars.length}`;
...
function setupEvents() {
    ...
    document.getElementById('btn-clear').addEventListener('click', clearUserCanvas);
